  ...
  implements INotificationProvider<AppriseCredentials>
{
  ...
  validate(credentials: unknown): credentials is AppriseCredentials {
    return (
      typeof credentials === "object" &&
      typeof (credentials as AppriseCredentials).appriseUrl === "string" &&
      (credentials as AppriseCredentials).appriseUrl.startsWith("http")
    );
  }
