...
export class SlackProvider implements INotificationProvider<SlackCredentials> {
  ...
  validate(credentials: unknown): credentials is SlackCredentials {
    return (
      typeof credentials === "object" &&
      credentials !== null &&
      typeof (credentials as { webhookUrl?: unknown }).webhookUrl ===
        "string" &&
      (credentials as { webhookUrl: string }).webhookUrl.startsWith(
