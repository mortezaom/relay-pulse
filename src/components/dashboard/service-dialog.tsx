                    ...
                    {field.value === "tcp" && (
                      <div className="mt-2 space-y-2 rounded-lg border border-blue-200 bg-blue-50 p-3 dark:border-blue-800 dark:bg-blue-950/20">
                        ...
                        <p className="text-blue-700 text-xs dark:text-blue-300">
                          TCP port checking requires an external Go service due
                          to Cloudflare Workers limitations. Configure the TCP
                          checker endpoint in Settings or deploy your own
                          instance.
                        </p>
                        <a
